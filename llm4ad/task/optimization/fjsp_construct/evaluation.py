...
from llm4ad.task.optimization.fjsp_construct.get_instance import GetData
from llm4ad.task.optimization.fjsp_construct.template import template_program, task_description
...
class FJSPEvaluation(Evaluation):
    ...
    def schedule_jobs(self, processing_times, n_jobs, n_machines, eva):
        ...
        while scheduled_ops < total_ops:
            ...
            # The eva function now returns (job_id, best_machine, best_processing_time)
